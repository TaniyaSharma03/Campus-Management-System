...
$faculty = $_POST["faculty"];
 $targetfolder = "uploads/assignments/";
...
if ($file_type=="application/pdf") 
 ...
 {
$sql="INSERT INTO facassignments(course,batch,subject,topic,faculty,file,type, loc) VALUES('$course','$batch','$subject','$topic','$faculty','$final_file', '$file_type','$targetfolder')";
