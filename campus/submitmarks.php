...
?>
<div class="main">
<h4 style="color:#1B2631"><center><b>Upload Marks</b></center></h4>
<div class="container">
...
<div class="row">
    <div class="col-25">
<label for="Title"><b>Total Marks</b></label>
</div>
    <div class="col-75">
     <input type="text"  name="total" required placeholder="Enter total marks.. " >   
</div>
</div>   
