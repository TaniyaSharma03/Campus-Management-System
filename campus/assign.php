...
$sql = "SELECT * FROM `facassignments` WHERE `course`= \"$Course\" AND `batch`= \"$batch\"";
$res = mysqli_query($conn, $sql);

echo "<h4><center>View Assignments</center></h4>";
echo "<table><tr><th>SUBJECT</th><th>TITLE</th><th>FACULTY</th><th> VIEW </th><th> UPLOAD </th></tr>";
...
<td><a href="assigndb.php?id=<?php echo $r['id']; ?>">Upload</a></td></tr>
<?php
}
echo "</table>";
$conn->close();
