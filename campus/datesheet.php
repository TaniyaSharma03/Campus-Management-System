...
<div class="main">
<h1 style="color:#1B2631"><center><b>Upload Datesheet</b></center></h1>
<div class="container">


  <form method="post" action="datesheetdb.php" enctype="multipart/form-data">
...
<label for="Title"><b>Title</b></label>
    ...
    <div class="col-75">
     <input type="text"  name="topic" required placeholder="Enter Datesheet title.. " >   
</div>
</div>
   ...
   <div class="row">
    <div class="col-25">
     <label for="file"><b>Datesheet</b></label>
