...
$i = 0;
echo "<h4><center>Marks of ".$Course. " Students, Batch: ".$batch."</center></h4>";
...
<td>
      ...
      <input type="hidden"  name="exam[<?php echo $i; ?>]" value="<?php echo $exam; ?>" readonly/>
      <input type="hidden"  name="total[<?php echo $i; ?>]" value="<?php echo $total; ?>" readonly/>
<td>
<input type="text"  name="marks[<?php echo $i; ?>]" required placeholder="Enter marks "/>
</td>
